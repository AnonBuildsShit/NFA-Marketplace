...
export const Head: FC<Props> = ({
  ogImage = 'https://ipfs.io/ipfs/QmY3SphNrD7P38YvLtbAKgdqNmbTGR1BnqVS9eAaUVQWSH',
  title = 'NFA | Non-Fungible Art',
  description = 'NFA | Non-Fungible Art',
  metatags = null,
}) => {
  return (
    <NextHead>
      ...
      <meta name="twitter:site" content="@NFA_Inc" />
      ...
      <meta property="og:image:alt" content="NFA | Non-Fungible Art" />
