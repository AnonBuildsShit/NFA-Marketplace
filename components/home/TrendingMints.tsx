...
type TrendingMints =
    paths['/collections/trending-mints/v1?period=24h']['get']['responses']['200']['schema']

type TrendingMintsProps = {
    collections: TrendingCollections
    loading?: boolean
}

export const TrendingMintsCards: React.FC<TrendingMintsProps> = ({
    collections,
    loading,
}) => {
